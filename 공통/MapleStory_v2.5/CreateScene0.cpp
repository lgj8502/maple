...
void CreateScene0::Init(HWND hWnd)
{
	...
	UI_MGR->AddImage("create_Background", L"CreateScene0_create_Background", { 0,0,1200,800 });
	...
	//////////////////////////////////////////////////
	//adventures 버튼
	UI_MGR->AddButton("adventures_Default", L"CreateScene0_create_adventures_Default", { 227,649 }, { 1.50f, 1.33333f });
	...
	auto CreateScene0_Func31 = [](void) {SCENE_MGR->ChangeScene(SCENE_INGAME); };
