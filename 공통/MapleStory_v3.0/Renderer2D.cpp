...
void Renderer2D::AddBitmap_RightTop(ID2D1Bitmap * _bitmap)
{
	m_BitmapList.push_back(_bitmap);
...
void Renderer2D::AddBitmap_Right(ID2D1Bitmap * _bitmap)
{
	m_BitmapList.push_back(_bitmap);
...
void Renderer2D::AddBitmap_RightBottom(ID2D1Bitmap * _bitmap)
{
	m_BitmapList.push_back(_bitmap);
...
void Renderer2D::AddBitmap_LeftTop(ID2D1Bitmap * _bitmap)
{
	m_BitmapList.push_back(_bitmap);
